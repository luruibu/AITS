...
<details>
<summary>🖼️ 点击查看完整界面截图 (3576x17030)</summary>

![AI Image Tree System Interface](static/img/18-1-2026_012_localhost.jpeg)

*完整的AI图像树系统界面展示 - 包含树状创意生成、关键词提取、分支探索、图像缩放等全部功能*

> **注意**: 此截图尺寸较大（3576 x 17030 像素），展示了完整的程序运行界面。建议在新标签页中打开查看，或直接运行程序体验完整功能。

</details>

### 🎯 核心功能展示

- **🌳 树状创意生成**: 从单一提示词出发，自动生成多层分支创意
- **🔍 智能关键词提取**: AI自动分析并提取核心创意元素  
- **🖼️ 高质量图像生成**: 基于Z-image Turbo模型的商业级图像输出
- **🔄 交互式探索**: 支持节点展开、图像缩放、全屏查看等丰富交互
- **⚙️ 灵活配置**: 多AI提供商支持，参数可调节

> 📖 **界面详细说明**: 
> - [界面功能展示](INTERFACE_SHOWCASE.md) - 完整功能区域说明和设计特点
> - [界面预览指南](INTERFACE_PREVIEW.md) - 关键功能区域和交互流程
...
**效果**：
- 删除所有创作树、节点和图像数据
- 收缩数据库文件到最小状态（通常 < 2 MB）
- 保留用户设置（AI配置、质量控制等）

**注意**：操作不可撤销，建议先备份重要数据

> 📖 详细说明请查看 [DATABASE_RESET_GUIDE.md](DATABASE_RESET_GUIDE.md)
